...
a.nama_ekskul,b.nama_lengkap,c.*,count(d.id_santri) as jml FROM ekskul c
INNER JOIN jns_ekskul a ON a.id_jns_ekskul=c.id_jns_ekskul INNER JOIN
pengasuh b ON c.id_pengasuh=b.id_pengasuh LEFT JOIN detail_ekskul d ON
c.id_ekskul=d.id_ekskul GROUP BY c.id_ekskul");
?>
