...
$sql = mysqli_query($koneksi, "SELECT * FROM jns_ekskul");
?>
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Data Jenis Ekskul</h1>
    </div>
    ...
    <?php endif; ?>
    <a href="frm_tambah_jns_ekskul.php" class="btn btn-sm btn-primary">Tambah Data</a>
    <br><br>
