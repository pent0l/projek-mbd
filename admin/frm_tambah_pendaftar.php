    ...
    <div class="table-responsive">
        <form action="simpan_pendaftaran.php" method="POST">
            <div class="col-6">
                ...
                <div class="mb-3">
                    <label for="exampleFormControlTextareal" class="form-label">Tempat Lahir</label>
                    <input type="text" name="tmpt_lahir" class="form-control" placeholder="Tempat Lahir">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlTextareal" class="form-label">Tanggal Lahir</label>
                ...
                <div class="mb-3">
                    <label for="exampelFormControlTextareal" class="form-label">Nama Ibu Kandung</label>
                    <input type="text" name="nama_ibu" class="form-control" placeholder="Nama Ibu">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlTextareal" class="form-label">Nama Ayah Kandung</label>
                    <input type="text" name="nama_ayah" class="form-control" placeholder="Nama Ayah">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlTextareal" class="form-label">Pekerjaan Ayah</label>
